  ...
  return (
    <section className=" bg-gradient-to-r from-[#12001f] via-[#0e001a] to-[#12001f] py-28 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        ...
        {/* LEFT ALIGNED HEADING (RESTORED STYLE) */}
        ...
        >
          {FEATURES.map((item, i) => (
            ...
            >
              ...
              >
                {/* ICON */}
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 text-3xl">
                  {item.icon}
                </div>
                ...
                {/* DESCRIPTION */}
                <p className="mt-4 text-sm leading-relaxed text-white font-inter text-inline">
                  {item.desc}
                </p>
              </motion.div>
            </motion.div>
