...
// Dynamic Our Works listing — server component
...
export const metadata: Metadata = {
  title: 'Our Work | MetaMaster – Digital Marketing Agency',
  description:
    'Explore our portfolio of case studies. From branding and performance marketing to full-scale digital transformation — see how MetaMaster drives real results.',
}
